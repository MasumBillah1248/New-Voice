...
def greeting():
    ...
    speak("I am new_voice. Please tell me how may I help you today?")


def play_music():
    music_dir = "E:\\New voice\\New-Voice\\music"
    try:
...
while True: 
    ...
    if "your name" in query:
        ...
        speak("I am function at full capacity sir!")
        logging.info("User asked about assistant's well_being.")


    elif "who made you" in query:
        speak("I was created by Masum Billah, a brilliant mind!")
        logging.info("User asked about assistant's creator.")

    elif "thank you" in query:
        speak("It's my pleasure sir. Aleays happy to help")
    ...
    #Git Hub
        ...
        logging.info("User requested to open Git Hub")
    ...
    #Jokes
        ...
        jokes = [
            ...
            "Why do Java developers sear glasses? Because the don't C sharp."
        ]
    ...
    #Wikipedia
        ...
        logging.info("User exited teh program.")
        exit()
